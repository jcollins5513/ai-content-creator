        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200 hover:shadow-md transition-shadow">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Generate Background</h3>
              <p className="text-gray-600 mb-4">Create professional photo-realistic backgrounds for your business.</p>
              <Link 
                href="/background-generator"
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200 hover:shadow-md transition-shadow">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Marketing Assets</h3>
              <p className="text-gray-600 mb-4">Generate logos, buttons, banners, and other marketing elements.</p>
              <Link 
                href="/marketing-assets"
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200 hover:shadow-md transition-shadow">
              ...
              <p className="text-gray-600 mb-4">Browse and reuse your generated backgrounds and assets.</p>
              <Link 
                href="/asset-library"
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200 hover:shadow-md transition-shadow">
              ...
              <p className="text-gray-600 mb-4">Upload, organize, and edit your personal image collection.</p>
              <Link 
                href="/test-images"
